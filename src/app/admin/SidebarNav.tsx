...
import {
  LayoutDashboard, Package, Table as TableIcon, CreditCard, Users,
          ...
          <li key={item.href}>
            <div
              className={cx(
                ...
                activeParent ? "bg-sky-700/25 text-slate-50"
            ...
            >
              ...
              <Icon
                className={cx(
                  ...
                  activeParent ? "text-sky-400" : "text-slate-400 group-hover:text-slate-2 00"
                )}
              />
              {hasChildren ? (
                    ...
                    <li key={c.href}>
                      <PrefetchLink
                        ...
                        className={cx(
                          ...
                          active ? "text-slate-50 bg-sky-700/20"
                                 : "text-slate-300 hover:text-slate-50 hover:bg-slate-800"
                        )}
                      >
                        <span
